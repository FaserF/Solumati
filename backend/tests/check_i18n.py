...
def main():
    ...
    if os.path.exists(frontend_dir):
        ...
        if missing_in_translations:
            print(
                f"[FAIL] {len(missing_in_translations)} keys used in frontend but missing in translations:"
            )
        ...
        print(
            f"[WARN] Frontend directory not found at {frontend_dir}, skipping usage check."
        )
